...
class GeminiContentGenerator:
    ...
    # =========================================================================
    # SYSTEM_INSTRUCTION (승팀 콘텐츠 전략 연구소 설계)
    # =========================================================================
    # 감성 J + 키워드 킹 + 적색 펜 + 봇 헌터 합의안
...
[1. Tone & Manner - 감성 J]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 타겟: 3040 냉담 교우(잠재 신자) 및 5060 기존 신자
- 어조: 따뜻하고 환대하는 느낌. 교조적이거나 딱딱한 말투 금지
- 종결어미: "~해요", "~랍니다" 같은 친근한 표현 사용

🚫 금지:
- "날씨가 춥네요", "벚꽃이 흐드러지네요" 등 계절/날씨 멘트 절대 금지 (Evergreen)
- "신부님 강론이 감동적이에요", "성가대 노래가 좋아요" 등 주관적 평가 금지
- "하느님", "주님" 과도하게 사용 금지
- "~하시옵소서" 등 고어체 사용 금지

✅ 권장:
- 오직 데이터(위치, 랜드마크, 설립연도)에 기반한 팩트 기반 감성 서술
- "복잡한 도심 속, 마음의 평화가 필요한 순간입니다" 같은 보편적 표현

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[2. Structure Guide - 적색 펜]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 분량: 3~4문장 (100~150자 내외)
- 모바일 기준 한 문단 3줄 이내
- 핵심 정보는 **볼드체**로 강조

구조:
1️⃣ 첫 문장: 성당 위치를 **주변 랜드마크와 함께** 설명
2️⃣ 중간: 방문하기 좋은 이유나 분위기 (팩트 기반)
3️⃣ 마지막: 부담 없는 환영 인사

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[3. SEO Strategy - 키워드 킹]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 랜드마크 이름을 자연스럽게 본문에 녹이기 (Narrative SEO)
- 키워드 단순 나열 금지

예시:
❌ "홈플러스, 이마트, 버스터미널 근처입니다."
✅ "홈플러스 조치원점에서 걸어서 5분, 장보기 전후 잠깐 들르기 좋아요."

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[4. Safety Rules - 봇 헌터]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 서론 시작을 매번 다르게 변주 (동일 패턴 = 스팸 판정)
- 없는 정보(주차장, 유아실 등) 절대 날조 금지
- 주임신부(priest) 이름은 언급하되, 년도별로 바뀌므로 간략히만 언급

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[예시 - Good]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"**노브랜드 세종조치원점(533m)**에서 가까워 장보기 전후 잠깐 들르기 좋아요.
현대적인 시설과 따뜻한 분위기가 매력적인 곳이랍니다.
편하게 미사에 참례해 보세요!"
"""
...
class HTMLContentBuilder:
    ...
    # =========================================================================
    # Styles (결팀 QA 기준: 모바일 5줄 이내, 가독성 최우선)
    # =========================================================================
    ...
    def build_intro_section(self, church: Dict) -> str:
        """Gemini AI로 생성한 소개글 섹션. (전팀 모바일 최적화)"""
        intro = self.gemini.generate_intro(church)
        return f'<p style="{self.INTRO_STYLE}">{intro}</p>'
...
'''
    ...
    def build_location_section(self, church: Dict) -> str:
        ...
        # 전팀: blockquote로 핵심 정보 강조
        html += f'<blockquote style="{self.BLOCKQUOTE_STYLE}">\n'
        
        if address:
            html += f'🏠 <strong>주소:</strong> {address}<br>\n'
            html += f'<a href="{naver_map_url}" target="_blank" style="color: #0ea5e9; text-decoration: none;">📍 네이버 지도로 길찾기</a>\n'
        
        if phone:
            html += f'<br>📞 <strong>전화:</strong> <a href="tel:{phone}" style="color: #0ea5e9;">{phone}</a>\n'
        
        html += '</blockquote>\n'
        
        # Nearby landmarks (관광지 위주로 변경됨 - enricher 설정 반영)
        if landmarks:
            html += '<h3 style="margin-top: 20px;">🏛️ 주변 관광명소</h3>\n'
